  ...
  <div className="container px-5 py-24 mx-auto flex flex-wrap">
    ...
    <div className="lg:w-1/2 sm:w-1/3 w-full rounded-lg overflow-hidden mt-6 sm:mt-0">
      <Image 
         ...
         height={600}
      />
      {/* <img className="object-cover object-center w-full h-full" src="https://www.webassetscdn.com/avira/prod-blog/wp-content/uploads/2017/05/avira_blog_finding-the-lowest-prices-while-shopping-trumps-safety-why-not-do-both.jpg" alt="stats"/> */}
    </div>
  </div>
</section>
  )
