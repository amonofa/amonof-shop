...
const Hero = () => {
  ...
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
      ...
      src="http://hipnoterapi.id/wp-content/uploads/2021/02/two-beautiful-women-shopping-town-scaled.jpg"/> */}
    </div>
    <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
      ...
      <div className="flex w-full md:justify-start justify-center items-end">
        ...
        <button className="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Send</button>
      </div>
